...
public class WsrAinf {
    ...
    public static void wsrIAccountMovements(String dtk, String stk, String gid, final VolleyCallback volleyCallback, RequestQueue requestQueue) throws JSONException {
        String data = "{\"V\":\"1\",\"R\": \"AIO.A.IAM.I\",\"DTK\":\""+dtk+"\",\"STK\":\""+stk+"\",\"GID\":\""+gid+"\"}";

        JSONObject object = new JSONObject(data);

        String url = "http://mmc.test.trulyplus.com/wsr_ainf/api/wsrIAccountMovements";
