...
public class WsrCash_Client {
    ...
    public static void wsrCashWithdraw(String dtk, String stk, int sid, int tid, String amt, final VolleyCallback volleyCallback, RequestQueue requestQueue) throws JSONException {
        String data = "{\"V\":\"2\",\"R\":\"ACO.C.CW.I\",\"DTK\":\""+dtk+"\",\"STK\":\""+stk+"\",\"GL\":{\"V\":\"1\",\"R\":\"string\",\"LAT\":0,\"LON\":0,\"ALT\":0,\"SPD\":0,\"BRN\":0,\"FDT\":\"yyyy-MM-ddTHH:mm:ssZ\"},\"SID\":"+sid+",\"TID\":"+tid+",\"AMT\":"+amt+"}";
